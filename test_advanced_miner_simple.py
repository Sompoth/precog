...
def create_mock_data(days=7, frequency="1min"):
    ...
    # Create DataFrame
    df = pd.DataFrame({"time": timestamps, "asset": "BTC", "ReferenceRateUSD": prices})
...
def test_prediction_accuracy():
    ...
    try:
        ...
        return _train_and_test_models(X_train, X_test, y_train, y_test)
...
def _train_and_test_models(X_train, X_test, y_train, y_test):
    """Helper function to train and test models."""
